...
async function problemB() {
  ...
  blue(stanza3)
  // readFile('poem-one/stanza-02.txt', async function (err, stanza2) {
  //   console.log('--AsyncAwait version (stanza two) --');
  //   await blue(stanza2);
  // });
  // readFile('poem-one/stanza-03.txt', async function (err, stanza3) {
  //   console.log('--AsyncAwait version (stanza three) --');
  //   await blue(stanza3);
  // });
...
async function problemC() {
  ...
  //   });
  // });
  // promisifiedReadFile('poem-one/stanza-02.txt', 'utf-8')
  // .then(stanza2=> {
  //   blue(stanza2)
  //   return promisifiedReadFile('poem-one/stanza-03.txt', 'utf-8')
  //   })
...
async function problemD() {
  ...
  // callback version
  // readFile('poem-one/wrong-file-name.txt', async function (err, stanza4) {
  ...
  // AsyncAwait version
  // readFile('poem-one/wrong-file-name.txt', async function (err, stanza4) {
  //   console.log('-- Async Await version (stanza four) --');
  //   if (err) throw new Error(magenta(err));
  //   else await blue(stanza4);
  // });
  try {
...
async function problemE() {
  ...
  // readFile('poem-one/stanza-03.txt', async function (err, stanza3) {
  //   console.log('-- Async Await version (stanza three) --');
  //   if (err) throw new Error(magenta(err))
  //   else await blue(stanza3);
  //   readFile('poem-one/wrong-file-name.txt', async function (err2, stanza4) {
  //     console.log('-- Async Await version (stanza four) --');
  //     if (err2) throw new Error(magenta(err2));
  //     else await blue(stanza4);
  //   });
  // });
}
