...
function problemA () {
  ...
  // promise version
  promisifiedReadFile('poem-one/stanza-01.txt', 'utf-8')
...
function problemB () {
  ...
  promisifiedReadFile('poem-one/stanza-03.txt', 'utf-8')
...
function problemD () {
  ...
  // promise version
  promisifiedReadFile('poem-one/wrong-file-name.txt', 'utf-8')
...
function problemE () {
  ...
  .then(stanza3 => {
    blue(stanza3)
  return promisifiedReadFile('poem-one/wrong-file-name.txt', 'utf-8')
  })
  .then(stanza4=> blue(stanza4))
  .catch(err => magenta(new Error(err)))
}
